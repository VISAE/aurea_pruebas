...
<script language="javascript" src="<?php echo $APP->rutacomun; ?>js/chosen_v1.8.7/chosen.jquery.js"></script>
<script language="javascript" src="<?php echo $APP->rutacomun; ?>js/popper.min.js"></script>
<script language="javascript" src="<?php echo $APP->rutacomun; ?>js/bootstrap.min.js"></script>
<script language="javascript" src="jsi/js2901.js"></script>
<link rel="stylesheet" href="<?php echo $APP->rutacomun; ?>js/chosen_v1.8.7/chosen.css" type="text/css"/>
