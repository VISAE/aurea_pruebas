...
$().ready(function(){
$("#plab09idtercero_doc").autocomplete("ac_111.php",{width:360,matchContains:true,no_result:'No coincidentes',selectFirst:false});
$("#plab09idtercero_doc").result(function(event, data, formatted){
	if (data[1]!=''){
		$("#plab09idtercero_td").val(data[2]);
		$("#plab09idtercero_doc").val(data[1]);
		ter_muestra('plab09idtercero', 1);
		}
	});
});